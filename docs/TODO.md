...
| DDD-06 | P0 | 多標的核對與 PDF 下載介面 | Interfaces／UI | DDD-04、DDD-05 | 待審查（v1 Excel 下載；PDF 入口已移除） | Codex／[PR #9](https://github.com/ChenYi0725/hackathon/pull/9)；多標的輸入尚未整合 ；[基準上傳修復驗收](ruleset-upload-fix.md)（本機已驗證，待 PR） |
