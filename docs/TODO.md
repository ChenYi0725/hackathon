...
| DDD-05 | P0 | PDF 報告與原書表產製 | Infrastructure | DDD-04 | 進行中（v1 分表匯出切片） | Codex／feat/form-exports；[範圍與驗收](form-exports.md) |
| DDD-06 | P0 | 多標的核對與 PDF 下載介面 | Interfaces／UI | DDD-04、DDD-05 | 進行中（v1 分表下載切片） | Codex／feat/form-exports；多標的輸入尚未整合 |
