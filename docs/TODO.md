...
| DDD-08 | P0 | 題目完整流程與回歸驗收 | Integration | DDD-05、DDD-06 | 進行中（本地核心切片） | Codex／`codex/core-workflow`；[實作與驗收](core-workflow.md)，既有 [PR #8](https://github.com/ChenYi0725/hackathon/pull/8)；完整住宅規則未完成 |
