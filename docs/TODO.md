...
| DDD-07 | P1 | 具版本篩選及引用的依據檢索 | Infrastructure | DDD-04（v2）；本次先接 v1 | 待審查（AWS KB／Agent 工具切片） | Codex／[PR #27](https://github.com/ChenYi0725/hackathon/pull/27)；[PR #6](https://github.com/ChenYi0725/hackathon/pull/6)（基礎 RAG）；[AWS KB 與工具路由驗收](aws-rag.md) |
