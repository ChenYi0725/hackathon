...
| DDD-08 | P0 | 題目完整流程與回歸驗收 | Integration | DDD-05、DDD-06 | 進行中（GPU 接線待實機；AWS GPU 配額為 0） | Codex／[GPU Draft PR #19](https://github.com/ChenYi0725/hackathon/pull/19)、[GPU 狀態](ocr-gpu.md)；[AWS 部署 PR #18](https://github.com/ChenYi0725/hackathon/pull/18)；既有 Agent [PR #8](https://github.com/ChenYi0725/hackathon/pull/8) |
