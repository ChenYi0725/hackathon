...
| DDD-08 | P0 | 題目完整流程與回歸驗收 | Integration | DDD-05、DDD-06 | 進行中（Agent／CPU OCR 切片） | Codex／[PR #8](https://github.com/ChenYi0725/hackathon/pull/8)、[PR #20](https://github.com/ChenYi0725/hackathon/pull/20)；[OCR 切換驗收](ocr-engines.md) |
